...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || '_9cd35c16-8a97-461a-92b1-f4ba7d8900f4.jpeg'
module.exports = 
  
  sessionName:  process.env.SESSION_ID ||  "session",
  botname:   process.env.BOT_NAME === undefined ? 'Ahmada-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'ahmada' : process.env.OWNER_NAME,
  author:  process.env.PACK_INFO === undefined ? 'bot' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO === undefined ? 'ahmada-Md' : process.env.PACK_INFO.split(";")[1],
